...
#            项目中特殊处理部分               #
#############################################
-keep class com.ym.chat.bean.** { *; }
-keep class com.ym.base.util.save.** { *; }
#-keep class com.ym.chat.rxhttp.bean.** { *; }
-keep class com.ym.base.util.save.BankListInfo { *; }
-keep class com.ym.base.util.save.SelectBankList { *; }
#内部成员和方法不混淆
...
#图片裁剪 com.github.yalantis:ucrop
-dontwarn com.yalantis.ucrop**
-keep class com.yalantis.ucrop** { *; }
-keep interface com.yalantis.ucrop** { *; }
...
-keep class * extends com.ym.base.mvvm.BaseViewModel
...
-keep public class * extends com.github.bumptech.glide.AppGlideModule
-keep public enum com.github.bumptech.glide.load.resource.bitmap.ImageHeaderParser$** {
   **[] $VALUES;
   public *;
}

-keep class com.ym.chat.utils.LanguageUtils