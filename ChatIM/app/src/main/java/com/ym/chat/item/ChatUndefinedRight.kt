 ...
 * 未知消息-右边
 */
class ChatUndefinedRight(
    private val onChatItemListener: OnChatItemListener,
) : QuickVBItemBinderPro<ChatMessageBean, ItemUndefinedChatRightBinding>() {
    ...
    override fun onCreateViewBinding(
        ...
        parent: ViewGroup,
        viewType: Int
    ): ItemUndefinedChatRightBinding {
        return ItemUndefinedChatRightBinding.inflate(layoutInflater, parent, false)
    }

    override fun convert(
        holder: BinderVBHolder<ItemUndefinedChatRightBinding>,
