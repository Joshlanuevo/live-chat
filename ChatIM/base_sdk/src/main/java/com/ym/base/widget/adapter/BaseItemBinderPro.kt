 ...
 * Binder 的基类
 */
abstract class BaseItemBinderPro<T, VH : BaseViewHolder> {
    ...
    internal var _adapter: BaseBinderAdapterPro? = null
    internal var _context: Context? = null

    open val adapter: BaseBinderAdapterPro
        get() {
    ...
    fun BaseViewHolder.getPositionReal():Int{
        return  adapterPosition - adapter.headerLayoutCount
    }
}