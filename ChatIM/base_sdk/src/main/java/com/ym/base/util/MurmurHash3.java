...
public final class MurmurHash3 {
    ...
    public static String hash_x86_128(byte[] data, int length, int seed, boolean toHex) {
        ...
        for (int i = 0; i < roundedEnd; i += 16) // round down to 16 byte block
        {
            ...
            int k2 = getIntLittleEndian(data, i + 4);
            int k3 = getIntLittleEndian(data, i + 8);
            int k4 = getIntLittleEndian(data, i + 12);
        ...
        return toHex ? String.format("%08x", h1) + String.format("%08x", h2) + String.format("%08x", h3) + String.format("%08x", h4).replaceAll("-", "") :
    ...
    public static void main(String[] args) {
        String key = "linus";
        String longs333 = MurmurHash3.hash_x86_128(key.getBytes(), key.length(), 42,true);
        System.out.println(longs333);
